...
?>
<html>
<head><title>phpbb_hash()er</title></head>
<body>
<h1>phpbb_hash()er</h1>
<?php
if (isset($_REQUEST['submit']) && isset($_REQUEST['password']))
{
?>
<h2>Result</h2>
...
<fieldset>
	...
	<dl>
		...
		<dd><input type="text" name="password" id="password" value="<?php echo isset($_REQUEST['password']) ? htmlspecialchars($_REQUEST['password']) : ''; ?>" /></dd>
	</dl>
</fieldset>
<p><input type="submit" name="submit" value="Hash" /></p>
</form>
</body>
</html>
